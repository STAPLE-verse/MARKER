...
-- CreateEnum
CREATE TYPE "AutoAssignNew" AS ENUM ('NONE', 'CONTRIBUTOR', 'TEAM', 'ALL');
...
-- CreateEnum
CREATE TYPE "EmailFrequency" AS ENUM ('NEVER', 'DAILY', 'WEEKLY');

-- CreateEnum
CREATE TYPE "NoteVisibility" AS ENUM ('PRIVATE', 'PM_ONLY', 'SHARED');
...
CREATE TABLE "User" (
    ...
    "tos" BOOLEAN,
    "emailProjectActivityFrequency" "EmailFrequency" NOT NULL DEFAULT 'DAILY',
    "emailOverdueTaskFrequency" "EmailFrequency" NOT NULL DEFAULT 'DAILY',
    "orcid" TEXT,
    "institution" TEXT,
...
CREATE TABLE "Task" (
    ...
    "elementId" INTEGER,
    "autoAssignNew" "AutoAssignNew" NOT NULL DEFAULT 'NONE',
...
CREATE TABLE "Form" (
    ...
    "tags" JSONB,
    "folderId" INTEGER,
    "app" TEXT NOT NULL DEFAULT 'staple',
...
CREATE TABLE "CommentReadStatus" (
    ...
    CONSTRAINT "CommentReadStatus_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "PublishedSchema" (
    ...
    "authorId" INTEGER NOT NULL,
    "contributors" JSONB,
    "relatedPublicationDoi" TEXT,
    "viewCount" INTEGER NOT NULL DEFAULT 0,
    "usageCount" INTEGER NOT NULL DEFAULT 0,
    "endorsementCount" INTEGER NOT NULL DEFAULT 0,
    "originFormVersionId" INTEGER,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "PublishedSchema_pkey" PRIMARY KEY ("pid")
);

-- CreateTable
CREATE TABLE "SchemaEndorsement" (
    "id" SERIAL NOT NULL,
    "userId" INTEGER NOT NULL,
    "publishedSchemaPid" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "SchemaEndorsement_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "_ProjectMemberToUser" (
    ...
    CONSTRAINT "_ProjectMemberToUser_AB_pkey" PRIMARY KEY ("A","B")
);
...
CREATE TABLE "_InvitationToRole" (
    ...
    CONSTRAINT "_InvitationToRole_AB_pkey" PRIMARY KEY ("A","B")
);

-- CreateTable
CREATE TABLE "_PendingTeamInvitations" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL,

    CONSTRAINT "_PendingTeamInvitations_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateTable
CREATE TABLE "_MilestoneToMilestone" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL,

    CONSTRAINT "_MilestoneToMilestone_AB_pkey" PRIMARY KEY ("A","B")
);
...
CREATE TABLE "_ElementToElement" (
    ...
    CONSTRAINT "_ElementToElement_AB_pkey" PRIMARY KEY ("A","B")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "CommentReadStatus_commentId_projectMemberId_key" ON "CommentReadStatus"("commentId", "projectMemberId");

-- CreateIndex
CREATE INDEX "note_project_author_idx" ON "Note"("projectId", "authorId");

-- CreateIndex
CREATE INDEX "note_author_pinned_idx" ON "Note"("authorId", "pinned");

-- CreateIndex
CREATE INDEX "PublishedSchema_keywords_idx" ON "PublishedSchema"("keywords");

-- CreateIndex
CREATE UNIQUE INDEX "PublishedSchema_familyId_version_key" ON "PublishedSchema"("familyId", "version");

-- CreateIndex
CREATE UNIQUE INDEX "SchemaEndorsement_userId_publishedSchemaPid_key" ON "SchemaEndorsement"("userId", "publishedSchemaPid");
...
-- CreateIndex
CREATE INDEX "_PendingTeamInvitations_B_index" ON "_PendingTeamInvitations"("B");

-- CreateIndex
CREATE INDEX "_RoleToTask_B_index" ON "_RoleToTask"("B");

-- CreateIndex
CREATE INDEX "_MilestoneToMilestone_B_index" ON "_MilestoneToMilestone"("B");
...
-- AddForeignKey
ALTER TABLE "CommentReadStatus" ADD CONSTRAINT "CommentReadStatus_commentId_fkey" FOREIGN KEY ("commentId") REFERENCES "Comment"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CommentReadStatus" ADD CONSTRAINT "CommentReadStatus_projectMemberId_fkey" FOREIGN KEY ("projectMemberId") REFERENCES "ProjectMember"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Note" ADD CONSTRAINT "Note_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "ProjectMember"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "PublishedSchema" ADD CONSTRAINT "PublishedSchema_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SchemaEndorsement" ADD CONSTRAINT "SchemaEndorsement_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SchemaEndorsement" ADD CONSTRAINT "SchemaEndorsement_publishedSchemaPid_fkey" FOREIGN KEY ("publishedSchemaPid") REFERENCES "PublishedSchema"("pid") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_PendingTeamInvitations" ADD CONSTRAINT "_PendingTeamInvitations_A_fkey" FOREIGN KEY ("A") REFERENCES "Invitation"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_PendingTeamInvitations" ADD CONSTRAINT "_PendingTeamInvitations_B_fkey" FOREIGN KEY ("B") REFERENCES "ProjectMember"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "_MilestoneToMilestone" ADD CONSTRAINT "_MilestoneToMilestone_A_fkey" FOREIGN KEY ("A") REFERENCES "Milestone"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_MilestoneToMilestone" ADD CONSTRAINT "_MilestoneToMilestone_B_fkey" FOREIGN KEY ("B") REFERENCES "Milestone"("id") ON DELETE CASCADE ON UPDATE CASCADE;
